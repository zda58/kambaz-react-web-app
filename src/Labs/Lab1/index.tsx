...
usually larger and bolder than the plain text and their subsection
headings. This document uses headings to introduce topics such as
HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags
can be used to format plain text so that it renders in a browser
as large headings. There are 6 heading tags for different sizes:
...
set of sentences. To force the browser to add vertical spacing, wrap
...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
        ...
        <div id="wd-lists">
            ...
            My favorite recipe:
            <ol id="wd-ribeye">
                <li>Pat steak and season</li>
                <li>Preheat oven to medium high</li>
                <li>Cook steak in oven until surface starts to brown</li>
                <li>Sear steak on pan with butter</li>
            </ol>
            ...
            <ul id="wd-your-books">
                <li>Children of Time</li>
                <li>A Fire Upon the Deep</li>
                <li>The Shadow of the Torturer</li>
            </ul>
        </div>
        <div id="wd-tables">
        <h4>Table Tag</h4>
